 ...
 * Usage example:
 * <pre>
 * com.forms.World w = new com.forms.World();
 *
 * com.forms.Turtle t = new com.forms.Turtle(w);
 * t.forward(300);
 * t.setPenWidth(10);
 * t.backward(100);
 * t.right(135);
...
public class Turtle {
     ...
     * Should only be called by com.forms.World class
    ...
    /**
     * Returns the current Color of the com.forms.Turtle.
    ...
    /**
     * Changes the current Color of the com.forms.Turtle.
    ...
    /**
     * Find out what direction the com.forms.Turtle is facing
    ...
    /**
     * Set the direction the com.forms.Turtle is facing
