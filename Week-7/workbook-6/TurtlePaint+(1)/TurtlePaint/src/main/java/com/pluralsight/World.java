 ...
 * Usage example:
 * <pre>
 * com.forms.World basic = new com.forms.World();
 * com.forms.World fancy = new com.forms.World(640, 480, Color.YELLOW);
 *
 * com.forms.Turtle t1 = new com.forms.Turtle(basic);
 * com.forms.Turtle t2 = new com.forms.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new com.forms.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    public World(int width, int height, Color backgroundColor) {
        super("com.forms.Turtle com.forms.World");
    ...
    /**
     * Should only called by the com.forms.Turtle class constructor
     */
    ...
    /**
     * Should only called by com.forms.Turtle class methods
     */
    ...
    /**
     * To be used by com.forms.Turtle class only
